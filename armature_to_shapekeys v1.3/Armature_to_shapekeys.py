bl_info = {
    ...
    "warning": "Beta Tool. Errors to be expected. Use apropriate Blender Version",
    "wiki_url": "",
}
...
class ArmatureToShapekeys(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        #Checks for missing Shapekey and creates if necessary
        ...
        if(modifierExists == True and modArmObjectExists == True):
            ...
            bpy.data.shape_keys[selected_shape_key_collection].key_blocks["Armature"].mute = True
